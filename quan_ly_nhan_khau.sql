...
CREATE TABLE `ho_khau` (
  `ID` int(11) NOT NULL,
  `maHoKhau` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
(17, 'TQB006', 39, 'HN03', 'Số 6 Tạ Quang Bửu, quận Hai Bà Trưng, Hà Nội', '2019-12-08', NULL, NULL, NULL),
(18, 'TQB005', 37, 'HN03', 'Số 5 Tạ Quang Bửu, quận Hai Bà Trưng, Hà Nội', '2019-12-08', NULL, NULL, NULL);
...
(39, NULL, 'Lê Công Anh', NULL, '1967-04-13', 'Nam', NULL, 'Hà Nội', 'Kinh', 'Không', 'Việt Nam', NULL, 'Số 6 Tạ Quang Bửu, quận Hai Bà Trưng, Hà Nội', 'Số 6 Tạ Quang Bửu, quận Hai Bà Trưng, Hà Nội', '12/12 chính quy', 'Tiến sĩ', 'Không', 'Anh trình độ C2', 'CEO', 'Công ty điện EVN', NULL, NULL, NULL, NULL, NULL, NULL, '2019-12-08', 1, NULL, NULL, NULL, NULL),
(40, NULL, 'Nguyễn Thị Tố Uyên', NULL, '1971-10-21', 'Nữ', NULL, 'Hà Nội', 'Kinh', 'Không', 'Việt Nam', NULL, 'Số 6 Tạ Quang Bửu, quận Hai Bà Trưng, Hà Nội', 'Số 6 Tạ Quang Bửu, quận Hai Bà Trưng, Hà Nội', '12/12 chính quy', 'Cử nhân', 'Không', 'Anh trình độ B1', 'Y tá', 'Bệnh viện quốc tế HJK', NULL, NULL, NULL, NULL, NULL, NULL, '2019-12-08', 1, NULL, NULL, NULL, NULL),
(41, NULL, 'Lê Phương Trinh', NULL, '1993-06-08', 'Nữ', NULL, 'Hà Nội', 'Kinh', 'Không', 'Việt Nam', NULL, 'Số 6 Tạ Quang Bửu, quận Hai Bà Trưng, Hà Nội', 'Số 6 Tạ Quang Bửu, quận Hai Bà Trưng, Hà Nội', '12/12 chính quy', 'Cử nhân', 'Không', 'Anh trình độ B1', 'Nhân viên văn phòng', 'Công ty ABC', NULL, NULL, NULL, NULL, NULL, NULL, '2019-12-08', 1, NULL, NULL, NULL, NULL),
(42, NULL, 'Trịnh Quang Hùng', '', '2021-12-10', 'Nam', NULL, 'Hải Dương', 'Tày', 'Không', 'Việt Nam', '', 'Hải Dương', 'Hải Dương', 'Mới sinh', 'Mới sinh', 'Có', 'Mới sinh', 'Mới sinh', 'Không có', NULL, NULL, NULL, NULL, NULL, NULL, '2022-01-10', 1, NULL, NULL, NULL, NULL);
...
CREATE TABLE `phan_anh` (
  `phanAnhID` int(11) NOT NULL,
  `nhanKhauID` int(11) NOT NULL,
...
INSERT INTO `phan_anh` (`phanAnhID`, `nhanKhauID`, `ngayPhanAnh`, `noiDung`, `phanLoai`, `trangThai`) VALUES
(1, 29, '2021-08-19', 'Chưa đổ rác', 'Phản ánh', 'Mới ghi nhận'),
(2, 34, '2021-08-12', NULL, 'Kiến nghị', 'Chưa giải quyết'),
(3, 33, '2021-08-12', NULL, 'Khiếu nại', 'Đã giải quyết'),
(4, 33, '2021-08-19', 'Tiếng ồn', 'Phản ánh', 'Đã giải quyết'),
(6, 34, '2021-08-19', 'Chưa đổ rác', 'Phản ánh', 'Đã giải quyết'),
(7, 41, '2021-09-10', NULL, 'Phản ánh', 'Đã giải quyết'),
(8, 35, '2021-08-12', NULL, 'Phản ánh', 'Đã giải quyết'),
(9, 36, '2021-08-12', NULL, 'Phản ánh', 'Đã giải quyết'),
(10, 30, '2021-08-12', NULL, 'Phản ánh', 'Đã giải quyết'),
(11, 31, '2021-08-12', NULL, 'Phản ánh', 'Đã giải quyết'),
(12, 32, '2021-08-12', NULL, 'Phản ánh', 'Đã giải quyết'),
(13, 29, '2021-08-12', NULL, 'Phản ánh', 'Đã giải quyết');
...
ALTER TABLE `nhan_khau`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `maNhanKhau` (`maNhanKhau`),
...
--
-- Indexes for table `phan_anh`
--
ALTER TABLE `phan_anh`
  ADD PRIMARY KEY (`phanAnhID`),
  ADD KEY `phan_anh_ibfk_1` (`nhanKhauID`);
...
--
-- AUTO_INCREMENT for table `phan_anh`
--
ALTER TABLE `phan_anh`
  MODIFY `phanAnhID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
-- Constraints for table `phan_anh`
--
ALTER TABLE `phan_anh`
  ADD CONSTRAINT `phan_anh_ibfk_1` FOREIGN KEY (`nhanKhauID`) REFERENCES `nhan_khau` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
